        ...
        <div class="student-grids">
          <div class="col-md-6 student-grid">
			<form  method="post">
				...
				&emsp;&emsp;&emsp;Complaint Description:<br>&emsp;&emsp;&emsp; <textarea rows="5" cols="50" name="cdesc" ></textarea><br><br>
				&emsp;&emsp;&emsp;<button type="submit"  name="submit" onclick="return otp()" class="btn btn-primary">Submit</button>
			</form>
    </div>
    <div class="col-md-6 student-grid">
      <img src="images/Complaint.jpg" class="img-responsive">
    </div>
    ...
    <div class="container">
      <div class="footer-grids">
        <div class="col-md-8 footer-grid">
          <h4>About Us</h4>
          <p>  Organisation of the Indian government responsible for maintaining a database of drivers and a database of vehicles for Maharastra.<span>
        ...
        <h4>Information</h4>
          <ul>
            ...
            <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:dyrto.42mh@gov.in."> dyrto.42mh@gov.in</a></li>
